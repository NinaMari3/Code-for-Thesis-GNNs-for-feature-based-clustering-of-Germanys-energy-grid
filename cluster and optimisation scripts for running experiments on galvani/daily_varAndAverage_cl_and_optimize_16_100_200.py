...
def prepare_data(n, carriers, time_resolution, include_time):
    # to combine time data and variance data: extract both and combine them
    data_time, adj_time, mapping_time, feature_names_time = utils.pypsa_to_pyg(n, carriers=carriers, verbose=True, include_time=True, time_resolution="24h")
    data_variance, adj, mapping, feature_names = utils_variance.pypsa_to_pyg(n, carriers=carriers, verbose=True, include_time=True, time_resolution="1", interval="D")

    # throw away the first 2 columns of the variance data to not have coordinates twice
    data_variance.x = data_variance.x[:, 2:]

    # combine the data 
    
    data = data_time # doesnt matter, will be overwritten
    data.x = torch.cat((data_time.x, data_variance.x), 1)
    scaler = MinMaxScaler()
...
# feature selection
carrier_configs = {
        "all": ["solar", "onwind", "offwind-ac", "offwind-dc"]
    }

# Run the experiment for 16 clusters
# time resolution does not matter because we set it in this experiment in prepare_data function to 1 day for average and variance
training_results, testing_results, clustered_nets = run_experiment(n, carrier_configs, time_resolution='1', num_clusters=16, seed = 10) 

# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cf_16_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_16_EX1"
...
training_results, testing_results, clustered_nets = run_experiment(n, carrier_configs, time_resolution='2h', num_clusters=100, seed = 10)

# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cf_100_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_100_EX1"
os.makedirs(output_directory, exist_ok=True)
os.makedirs(network_directory, exist_ok=True)
...
# Run the experiment for 200
training_results, testing_results, clustered_nets = run_experiment(n, carrier_configs, time_resolution='2h', num_clusters=200, seed = 10)

# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cf_200_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_200_EX1"
os.makedirs(output_directory, exist_ok=True)
os.makedirs(network_directory, exist_ok=True)
...
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_16_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_16_EX1"
...
############## 100 clusters ################
# Define input and output folders
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_100_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/ddaily_varianceAndAverage/cn_100_EX1"
os.makedirs(output_folder, exist_ok=True)
...
############## 200 clusters ################
# Define input and output folders
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_200_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_varianceAndAverage/cn_200_EX1"
os.makedirs(output_folder, exist_ok=True)
