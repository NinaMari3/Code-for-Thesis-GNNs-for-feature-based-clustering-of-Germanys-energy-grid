...
def prepare_data(n, carriers, time_resolution, include_time):
    """
    Prepares the data and features for a carrier configurations.
    Normalizes the coordinates and converts the PyPSA network to a PyG object.
    
    Args:
        n (pypsa.Network): The PyPSA network object.
        carriers: List of carrier used for the clustering
        time_resolution: Time resolution which should be applied on the data
    ...
    data, adj, mapping, feature_names = utils_variance.pypsa_to_pyg(n, carriers, verbose=True, include_time=include_time, time_resolution=time_resolution, interval='M')
    scaler = MinMaxScaler()
...
training_results, testing_results, clustered_nets = run_experiment(n, carrier_configs, time_resolution='2h', num_clusters=16, seed = 10)

# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cf_16_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_16_EX1"
...
# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cf_100_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_100_EX1"
os.makedirs(output_directory, exist_ok=True)
os.makedirs(network_directory, exist_ok=True)
...
# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cf_200_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_200_EX1"
os.makedirs(output_directory, exist_ok=True)
os.makedirs(network_directory, exist_ok=True)
...
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_16_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_16_EX1"
...
############## 100 clusters ################
# Define input and output folders
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_100_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_100_EX1"
os.makedirs(output_folder, exist_ok=True)
...
############## 200 clusters ################
# Define input and output folders
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_200_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/monthly_variance/cn_200_EX1"
os.makedirs(output_folder, exist_ok=True)
