...
def prepare_data(n, carriers, time_resolution, include_time):
    ...
    data, adj, mapping, feature_names = utils_variance.pypsa_to_pyg(n, carriers, verbose=True, include_time=include_time, time_resolution=time_resolution, interval='D')
    scaler = MinMaxScaler()
...
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cf_16_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_16_EX1"
...
# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cf_100_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_100_EX1"
os.makedirs(output_directory, exist_ok=True)
os.makedirs(network_directory, exist_ok=True)
...
# create output folders
output_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cf_200_EX1"
network_directory = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_200_EX1"
os.makedirs(output_directory, exist_ok=True)
os.makedirs(network_directory, exist_ok=True)
...
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_16_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_16_EX1"
...
############## 100 clusters ################
# Define input and output folders
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_100_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_100_EX1"
os.makedirs(output_folder, exist_ok=True)
...
############## 200 clusters ################
# Define input and output folders
input_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_200_EX1"
output_folder = "/mnt/qb/work/ludwig/lqb072/Thesis4/daily_variance/cn_200_EX1"
os.makedirs(output_folder, exist_ok=True)
